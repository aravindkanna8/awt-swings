...
public class CusMail {
	...
	public CusMail(String mail,String name,int exp) {
		...
		try {
			...
			message.setSubject("JEWELLERY BILL");
			message.setText( "Hello "+ name+",\nthanks for shopping with us, you have purchased jewellery worth Rs."+exp+" with us.\n\n\nWe look forward shopping with you again");

...
public class ManagerDashboard  extends JFrame implements ActionListener,WindowListener {
	  ...
	  JTextField txt_gold,txt_silver;
	    ...
	    JButton jbtn_update,jbtn_customer,jbtn_employee,jbtn_exchange,jbtn_jewelry,jbtn_order,jbtn_sales;
	    String mang_id;
	    
	    public ManagerDashboard(String name,String uid)
	    {
            ...
            JLabel co=new JLabel(new ImageIcon("C:\\Users\\madhavan_vr\\Desktop\\images\\d7.jpg"));
	    	add(co);
	    ...
	    //	JFrame JForm = new JFrame();
	      ...
	      // setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	        lbl_title=new JLabel("MANAGER DASHBOARD");
	       ...
	       lbl_SGram=new JLabel("10 gram");
	        ...
	        jbtn_sales=new JButton("VIEW SALES");
	      ...
	      //  jbtn_owner.setBackground(Color.DARK_GRAY);
	        ...
	        jbtn_sales.addActionListener(this);
	       ...
	       /* jbtn_owner.setBounds(1157,382,372,117);
	        ...
	        jbtn_sales.setBounds(1000,550,450,35);
	    ...
	    public void actionPerformed(ActionEvent ae)
	    {
	        ...
	        if(obj_source==jbtn_sales)
	        {
	        
	        }
	        if(obj_source==jbtn_order)
	        {
	        	Cart ob=new Cart(mang_id);
	        }

...
public class SilverModule  extends JFrame implements ActionListener {
	  ...
	  JLabel lbl_product_id,lbl_product_type,lbl_sup_id,lbl_desc,lbl_hsn,lbl_gross_wt,lbl_stone_wt,lbl_net_wt,lbl_stone_value,lbl_MC,lbl_total,lbl_purity,lbl_p_date;
	    JTextField txt_product_id,txt_sup_id,txt_desc,txt_hsn,txt_gross_wt,txt_stone_wt,txt_net_wt,txt_stone_value,txt_MC,txt_total,txt_purity,txt_p_date;
	    ...
	    public  SilverModule(){
	       ...
	       setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	        ...
	        lbl_purity=new JLabel("PURITY(91.6 or 75.1 )");
	        ...
	        lbl_MC.setBounds(100, 500, 145, 25);
	        ...
	        txt_MC.setBounds(280, 500, 120, 25);
	    ...
	    public void actionPerformed(ActionEvent ae){
	        ...
	        if(obj_source==jbtn_submit){
	            ...
	            try{
	                ...
	                float purity=Float.parseFloat(txt_purity.getText());
	                String date=txt_p_date.getText();
	                
	                        Connection con = DataBase1.getConnection();
	                   Statement stmt=con.createStatement();
	                   String query =  "insert into silverjewel values('" + str_pid + "','" + str_pt + "','" + str_sid + "','" + str_desc + "','" + str_hsn + "','" + gwt + "','" + swt + "','" + net_wt + "','" + st_value + "','" + MC + "'," + stock + "," + purity + ",to_date('" + date + "','dd/mm/yyyy'))";
		                  // String
	                  // String query="insert into silverjewel values("+str_pid+",'"+str_pt+"','"+str_sid+"','"+str_desc+"','"+str_hsn+"','"+gwt+"','"+swt+"','"+net_wt+"','"+st_value+"','"+MC+"','"+stock+"',"+purity+")"  ;      
